            ...
            div [ _koBind "with: newCollectionVM"; _class "modal-dialog modal-lg" ] [
                div [ _class "modal-content" ] [
                    div [ _class "modal-header" ] [
                        ...
                        button [ _type "button"; _class "close"; _aria "label" "Close"; _koBind "click: function() { $parent.switchView(CurrentView.MASTER); }" ] [ span [ _aria "hidden" "true"] [ encodedText "&times" ] ]
                    ]
                    div [ _class "modal-body" ] [
                        ...
                        Forms.formGroup <@ vm.Name @> "Use a name specific to the collection."
                        Forms.formGroup <@ vm.Description @> "Your collection description could include the motivation for creating the collection, geographical coverage, or the nature of the material, for example."
                        ...
                        div [ _class "form-check" ] [
                            label [ _class "form-check-label" ] [
                                input [ _class "form-check-input"; _type "radio"; _name "accessMethod"; _id "digital"; _koBind "checked: accessMethod" ]
                            ...
                            label [ _class "form-check-label" ] [
                                input [ _class "form-check-input"; _type "radio"; _name "accessMethod"; _id "institution"; _koBind "checked: accessMethod" ]
                                strong [] [ encodedText "Institution." ]
                                encodedText "The reference material is housed within an institution."
                            ]
                            label [ _class "form-check-label" ] [
                                input [ _class "form-check-input"; _type "radio"; _name "accessMethod"; _id "private"; _koBind "checked: accessMethod" ]
            ...
            div [ _koBind "with: calibrateVM"; _class "modal-dialog modal-lg" ] [
                div [ _class "modal-content" ] [
                    div [ _class "modal-header" ] [
                        ...
                        button [ _type "button"; _class "close"; _koBind "click: function() { $parent.switchView(CurrentView.MASTER); }" ] [ span [] [ encodedText "&times;" ] ]
                    ]
                    div [ _class "modal-body" ] [
                        Grid.row [
            ...
            div [ _koBind "with: newSlideVM"; _class "modal-dialog modal-lg" ] [
                div [ _class "modal-content" ] [
                    div [ _class "modal-header" ] [
                        ...
                        button [ _type "button"; _class "close"; _koBind "click: function() { $parent.switchView(CurrentView.MASTER); }" ] [ encodedText "&times" ]
                    ]
                    div [ _class "modal-body" ] [
                        p [] [ 
                        ...
                        Grid.row [
                            Grid.column Small 3 [
                                input [ _koBind "value: family, event: { blur: capitaliseFirstLetter($element) }"; _type "text"; _id "original-Family"; _class "form-control"; _autocomplete "off"; _placeholder "Family"; _on "blur" "disable('Family');"; _on "keyup" "suggest(this, 'Family');" ]
                                div [ _class "dropdown-menu taxon-dropdown"; _id "FamilyList"; _style "display:none" ] []
                            ]
                            Grid.column Small 3 [
                                input [ _koBind "value: genus, enable: rank() != 'Family', event: { blur: capitaliseFirstLetter($element) }"; _type "text"; _id "original-Genus"; _class "form-control"; _autocomplete "off"; _placeholder "Genus"; _on "blur" "disable('Genus');"; _on "keyup" "suggest(this, 'Genus');" ]
                                div [ _class "dropdown-menu taxon-dropdown"; _id "GenusList"; _style "display:none" ] []
                            ]
                            Grid.column Small 3 [
                                input [ _koBind "value: species, disable: rank() != 'Species'"; _type "text"; _id "original-Species"; _class "form-control"; _autocomplete "off"; _placeholder "Species"; _on "blur" "disable('Species');"; _on "keyup" "suggest(this, 'Species');" ]
...
let appView =
    [
        ...
        "/js/viewer/focusslider.js"
        "/js/viewer/measuringline.js"
        "/lib/datatables.net/js/jquery.dataTables.min.js"
        "/js/digitise/app.js" ] "Digitise Dashboard" "Use this tool to digitise your collections. A digitised slide contains two components: (1) metadata, and (2) images."
